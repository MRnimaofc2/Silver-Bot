...
if (Config.WORKTYPE == 'private') {
    ...
    Silver.addCommand({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Silver.addCommand({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Silver.addCommand({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
