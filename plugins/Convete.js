...
const $ = cheerio.load(res.data)
  ...
  return link
    ...
    Silver.addCommand({pattern: 'mp4audio$', fromMe: wk, desc: Lang.MP4TOAUDİO_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Silver.addCommand({pattern: 'photo$', fromMe: wk, desc: Lang.STİCKER_DESC, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
    ...
    Silver.addCommand({pattern: 'vsticker$', desc: Lang.ANİM_STİCK, fromMe: wk, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
